...
URL= "https://%s"
url = "//recommendation?cluster_moid=%s&cloud=vmc&is_profiling=False&vcenter_ip=%s"%(cluster_moid , VCENTER_IP)


URL      = URL % (APPLIANCE_IP)
headers = {'Content-type': 'application/json'}

class Cluster_Cloudburst_Planning_Test(unittest.TestCase):
