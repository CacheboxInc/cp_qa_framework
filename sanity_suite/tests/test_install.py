...
from unit_suite.tests.utils import *
...
class InstallQA(QAMixin, unittest.TestCase):
    ...
    def test_02_install_on_cluster(self):
        ...
        try:
            ...
            logger.info(self.install_on_cluster_url)
            logger.info(values)
            logger.info(ret)
    ...
    def test_04_configure_cluster(self):
        try:
            ...
            logger.info(self.configure_cluster_url)
            logger.info(values)
            logger.info(ret)
    ...
    def test_05_register_plugin(self):
        try:
            ...
            logger.info(self.register_plugin_url)
            logger.info(values)
            logger.info(ret)
    ...
    def test_06_uninstall_on_cluster(self):
        ...
        try:
            ...
            logger.info(self.uninstall_on_cluster_url)
            logger.info(values)
            logger.info(ret)
    ...
    def test_07_unregister_plugin(self):
        try:
            ...
            logger.info(self.unregister_plugin_url)
            logger.info(values)
            logger.info(ret)
...
if __name__ == "__main__":
    unittest.main(argv=["install.py"] + args)
